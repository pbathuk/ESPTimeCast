...
MD_MAX72XX::fontType_t mFactory[] PROGMEM = 
{
	...
	0, 	// 127 - ''
	3, 224, 80, 224,// 128 - Tiny 'A' (3 pixels wide, bottom aligned, 4 high)
	3, 240, 80, 32,	// 129 - Tiny 'P' (3 pixels wide, bottom aligned, 4 high)
	3, 240, 32, 240, // 130 - Tiny 'M' (3 pixels wide, bottom aligned, 4 high)
	0, 	// 131 - 'ƒ'
	3, 13, 17, 253,  	// 132 - '„'
	3, 253, 149, 101, 	// 133 - '…'
	3, 4, 126, 4, 	// 134 - '†'
