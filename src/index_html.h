...
<div id="autoDimmingNote" class="small">
  Requires a valid OpenWeather / Home Assistant API key.
</div>
...
window.onload = function () {
  ...
  .then(data => {
    ...
    const haapiInputEl = document.getElementById('homeAssistantApiKey');
...
async function submitConfig(event) {
  ...
  data.weatherUnits = document.getElementById('weatherUnits').checked;
  ...
  if (ssidInput.value !== "********" && ssidInput.value !== "") {
      data.ssid = ssidInput.value;
  }
  ...
  data.homeAssistantURL = document.getElementById('homeAssistantURL').value;
  data.haTempSensor = document.getElementById('haTempSensor').value;
  data.haHumiditySensor = document.getElementById('haHumiditySensor').value;
